            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "<<< Merry Christmas >>>",
                        "Giáng sinh vui vẻ nha Thy iu !!!, Chúc công chúa Minh Thy có một mùa noel thật ấm áp nha. ",
                        "Giáng sinh tới rùi, quà hôm qua mình tặng công chúa Thy là 1 ông già noen siu cute lun, mình lựa kĩ lắm, ông già noen này chuẩn xì tin nhất, hí hí.",
                        "Mùa này lạnh, nhớ mặc áo khoác mỗi khi đi làm để bị cảm lạnh đó (xu 1 cái là áo khoác mình tặng bị lệnh size, hu hu)",
                        "Noen tới rùi, dẹp deadline lun Thy và đón giáng sinh hoy :)))",
                        ],
                        typeSpeed: 50,
                        startDelay: 500,
                        backSpeed: 20,
